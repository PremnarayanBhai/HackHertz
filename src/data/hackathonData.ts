...
export const hackathonInfo: HackathonInfo = {
  ...
  venue: "Shree Swaminarayan Institute of Technology",
  collegeName: "Shree Swaminarayan Institute of Technology",
  city: "SSIT Campus, Gujarat",
  mode: "Offline",
  teamSizeMin: 2,
  teamSizeMax: 4,
  registrationFee: "₹400 per team",
  totalPrizePool: "₹XXXX",
  contactEmail: "organizers@hackhertz.edu",
  contactPhone: "+1 (800) 555-HACKHERTZ",
...
export const domains: Domain[] = [
  ...
  {
    id: "animation",
    name: "Animation & Creative Media",
    shortDescription: "Interactive 3D graphics, procedural WebGL/WebXR animations, generative motion canvases, and physics-driven simulations.",
    icon: "Clapperboard",
    color: "#e879f9", // Fuchsia
    bgGlow: "rgba(232, 121, 249, 0.15)",
    exampleProblemsCount: 2,
    exampleProblems: [
      "Interactive 3D WebXR Motion & Kinetic Physics Sandbox",
      "Real-Time Procedural Character & Shader Animation Studio"
    ]
  },
  {
    id: "crisis-tech",
...
export const problemStatements: ProblemStatement[] = [
  ...
  {
    id: "ps-05",
    problemId: "ARC-ANM-05",
    title: "Interactive 3D WebXR Kinetic Physics & Particle Sandbox",
    domainId: "animation",
    domainName: "Animation & Creative Media",
    difficulty: "Hard",
    description: "Create a fluid, high-performance in-browser 3D animation environment where creators can simulate realistic cloth physics, gravity fields, and particle fluid dynamics with real-time keyframing and exportable motion sequences.",
    expectedSolution: "WebXR / Three.js 3D canvas with intuitive timeline scrubber, shader graph nodes, and 60fps physics simulation.",
    suggestedTech: ["Three.js / React Three Fiber", "GLSL Shaders", "Motion", "Tailwind CSS"],
    sponsor: "Arcade Master Studios",
    pdfUrl: "#"
  },
  {
    id: "ps-06",
    problemId: "ARC-ANM-06",
    title: "Generative Procedural Character & Sprite Animation Studio",
    domainId: "animation",
    domainName: "Animation & Creative Media",
    difficulty: "Intermediate",
    description: "Develop a creative web application that takes 2D pixel art or vector character sketches and automatically calculates skeletal bone rigs, walking/jumping animation cycles, and smooth tweening transitions for indie game developers.",
    expectedSolution: "Interactive canvas editor with bone rigging controls, auto-generated walk cycles, and sprite sheet export.",
    suggestedTech: ["HTML5 Canvas", "React", "Paper.js / Pixi.js", "Tailwind CSS"],
    pdfUrl: "#"
  },
  {
    id: "ps-07",
...
export const sponsors: Sponsor[] = [
  {
    ...
    description: "Enterprise Security & Threat Intelligence Leader"
  },
  {
    id: "sp-02",
    name: "Apex Tech Labs",
    tier: "Title",
    logo: "⚡ APEX LABS",
    website: "https://example.com/apexlabs",
    description: "Next-Generation Cloud & AI Infrastructure"
  },
  {
    id: "sp-03",
    name: "Arcade Master Studios",
    tier: "Gold",
    logo: "🕹️ ARCADE MASTER",
    website: "https://example.com/arcademaster",
    description: "AAA Gaming Engine & Spatial Computing"
  },
  {
    id: "sp-04",
    ...
    description: "High-Performance Compute & Kubernetes"
  },
  {
    id: "sp-05",
    name: "VaultPass Security",
    tier: "Silver",
    logo: "🔑 VAULTPASS",
    website: "https://example.com/vaultpass",
    description: "Zero-Knowledge Authentication APIs"
  },
  {
    id: "sp-06",
    name: "DevSphere Network",
    tier: "Community",
    logo: "🌐 DEVSPHERE",
    website: "https://example.com/devsphere",
    description: "Global Developer Ecosystem"
  },
  {
    id: "sp-07",
    name: "RetroByte Media",
    tier: "Media",
    logo: "📻 RETROBYTE",
    website: "https://example.com/retrobyte",
    description: "Tech & Gaming Podcast Network"
  }
];
...
export const organizers: Organizer[] = [
  ...
  {
    id: "org-03",
    role: "Sponsorship & Industry Lead",
    name: "Ethan Wright",
    email: "sponsorships@hackhertz.edu",
