      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            {/* SSIT Organizing Institute Emblem & SSIP Partner Badge */}
            <div className="pt-1 space-y-2">
              <a
                href="https://ssit.co.in"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-3 py-2 rounded-xl bg-slate-900/90 border border-yellow-500/40 hover:border-yellow-400 hover:shadow-[0_0_15px_rgba(250,204,21,0.2)] transition-all group"
              >
                <SSITLogo size="sm" glow={true} className="group-hover:scale-105 w-8 h-8" />
                <div className="text-left">
                  <span className="text-[10px] font-pixel text-yellow-400 block tracking-wider">ORGANIZED BY SSIT</span>
                  <span className="text-xs font-bold text-slate-200 block group-hover:text-yellow-400 transition-colors leading-tight">Shree Swaminarayan Institute of Technology</span>
                  <span className="text-[9px] font-mono text-slate-400 block">Bhat, Gandhinagar, Gujarat</span>
                </div>
              </a>
              ...
              <div>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 px-3 py-2 rounded-xl bg-slate-900/90 border border-red-500/40 hover:border-red-400 hover:shadow-[0_0_15px_rgba(237,28,36,0.2)] transition-all group"
                >
                  <SSIPLogo size="sm" glow={true} className="group-hover:scale-105" />
                  <div className="text-left">
                    <span className="text-[10px] font-pixel text-red-400 block tracking-wider">SUPPORTED BY SSIP</span>
                    <span className="text-[9px] font-mono text-slate-400 block">Student Startup & Innovation Policy, Govt. of Gujarat</span>
                  </div>
                </a>
              </div>
            </div>

            {/* Social Links & Contact Action Buttons (Mobile Optimized) */}
            <div className="flex flex-wrap items-center gap-2.5 pt-2">
              <a
                href="#organization"
                onClick={() => soundManager.playClick()}
                id="footer-contact-button"
                className="px-3.5 py-2 rounded-xl bg-pink-500/20 hover:bg-pink-500/30 border border-pink-500/60 text-pink-300 hover:text-white transition-all flex items-center gap-2 text-xs font-pixel shadow-[0_0_12px_rgba(236,72,153,0.25)] hover:shadow-[0_0_18px_rgba(236,72,153,0.4)]"
              >
                <Phone className="w-3.5 h-3.5 text-pink-400 animate-pulse" />
                <span>CONTACT US</span>
              </a>

              {hackathonInfo.socialLinks.whatsapp && (
                <a
                  href={hackathonInfo.socialLinks.whatsapp}
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => soundManager.playCoin()}
                  id="footer-whatsapp-button"
                  title="Join Official WhatsApp Channel"
                  className="px-3.5 py-2 rounded-xl bg-emerald-500/20 hover:bg-emerald-500/30 border border-emerald-500/60 text-emerald-300 hover:text-white transition-all flex items-center gap-2 text-xs font-pixel shadow-[0_0_12px_rgba(16,185,129,0.25)] hover:shadow-[0_0_18px_rgba(16,185,129,0.4)]"
                >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                title="Follow SSIT Aavishkar on Instagram"
                className="px-3.5 py-2 rounded-xl bg-slate-900 border border-slate-800 text-slate-300 hover:text-pink-400 hover:border-pink-400/50 transition-colors flex items-center gap-2 text-xs font-mono"
              >
            ...
            <div className="pt-1">
              <a
                href={`tel:${hackathonInfo.contactPhone.replace(/\s+/g, '')}`}
                className="inline-flex items-center gap-2 text-xs font-mono text-slate-400 hover:text-pink-300 transition-colors"
              >
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-ping inline-block" />
                <span>Helpline: <strong className="text-white font-bold">{hackathonInfo.contactPhone}</strong> ({hackathonInfo.helplineLead})</span>
              </a>
            </div>
          </div>
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              ...
              <li><a href="#problems" className="hover:text-white transition-colors">Problem Statements</a></li>
              ...
              <li><a href="#organization" className="hover:text-pink-300 text-pink-400/90 font-medium transition-colors flex items-center gap-1">Contact & Organizing Crew</a></li>
          ...
          <div className="md:col-span-4 space-y-3">
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              ...
              <li><a href="#organization" className="hover:text-white transition-colors">Organization & Crew</a></li>
            </ul>
