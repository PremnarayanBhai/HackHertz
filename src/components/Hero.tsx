...
export const Hero: React.FC<HeroProps> = ({ onOpenRegister }) => {
  ...
  return (
    <SectionWrapper id="hero" accent="yellow" bgVariant="abyss" animVariant="lift" className="min-h-screen pt-28 pb-16 flex items-center bg-maze-pattern">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <ScrollReveal variant="fade-right" className="lg:col-span-7 space-y-6 text-center flex flex-col items-center">
            ...
            {/* Status Badge */}
            <div className="inline-flex flex-wrap items-center justify-center gap-1.5 sm:gap-2.5 px-3 sm:px-4 py-1.5 rounded-full bg-slate-900/90 border border-yellow-400/40 shadow-[0_0_15px_rgba(250,204,21,0.2)] max-w-full">
              <span className="px-2 py-0.5 rounded bg-yellow-400/20 text-yellow-400 font-pixel text-[9px] border border-yellow-400/30 whitespace-nowrap">
                STAGE 01 [UNLOCKED]
              </span>
              <span className="w-2 h-2 rounded-full bg-emerald-400 animate-ping shrink-0" />
              <span className="font-pixel text-[9px] sm:text-[11px] text-yellow-400 tracking-wider uppercase whitespace-nowrap">
                OPEN FOR REGISTRATIONS
              </span>
              <span className="text-slate-500 hidden sm:inline">•</span>
              <span className="text-[11px] sm:text-xs text-slate-300 font-mono whitespace-nowrap">
            ...
            <div className="space-y-4 text-center flex flex-col items-center w-full">
              {/* Official Emblems: SSIT Gandhinagar, HackHertz 2.0 & SSIP Gujarat */}
              <div className="flex items-center justify-center gap-3 sm:gap-5 flex-wrap">
                {/* SSIT Organizing Institute Crest */}
                <a
                  href="https://ssit.co.in"
                  target="_blank"
                  rel="noopener noreferrer"
                  title="Shree Swaminarayan Institute of Technology (SSIT), Gandhinagar"
                  className="p-2.5 sm:p-3 rounded-2xl bg-slate-950/85 border border-yellow-500/40 hover:border-yellow-400 hover:shadow-[0_0_25px_rgba(250,204,21,0.25)] transition-all flex items-center gap-2.5 sm:gap-3 group/ssit"
                >
                  <SSITLogo size="sm" glow={true} className="group-hover/ssit:scale-105 transition-transform w-8 h-8 sm:w-10 sm:h-10" />
                  <div className="text-left">
                    <span className="text-[9px] sm:text-[10px] font-pixel text-yellow-400 block tracking-wider">ORGANIZED BY SSIT</span>
                    <span className="text-[10px] sm:text-xs font-bold text-slate-200 block leading-tight">Shree Swaminarayan Institute of Technology</span>
                  </div>
                </a>

                {/* HackHertz 2.0 Official Badge */}
                <div className="relative group">
                  ...
                  <HackHertzLogo size="xl" variant="badge" className="relative w-16 h-16 sm:w-20 sm:h-20 shadow-2xl group-hover:scale-105 transition-transform" />
                </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  title="Student Startup & Innovation Policy (SSIP), Education Dept., Govt. of Gujarat"
                  className="p-2.5 sm:p-3 rounded-2xl bg-slate-950/85 border border-red-500/40 hover:border-red-400 hover:shadow-[0_0_25px_rgba(237,28,36,0.3)] transition-all flex items-center gap-2.5 sm:gap-3 group/ssip"
                >
                  <SSIPLogo size="sm" glow={true} className="group-hover/ssip:scale-105 transition-transform" />
                  <div className="text-left">
                    <span className="text-[9px] sm:text-[10px] font-pixel text-red-400 block tracking-wider">SUPPORTED BY SSIP</span>
                    <span className="text-[9px] sm:text-[10px] font-mono text-slate-400 block leading-tight">Govt. of Gujarat</span>
                  </div>
                </a>
              </div>
            ...
            <p className="text-slate-300 text-base sm:text-lg max-w-2xl mx-auto text-center leading-relaxed">
              Step into the ultimate 30-hour intercollege technical arcade. Build cutting-edge AI, Cyber Security, Open Innovation, and Defense applications, battle on the leaderboard, and claim your share of over <strong className="text-yellow-400">{hackathonInfo.totalPrizePool}</strong> in rewards!
            </p>
          ...
          <ScrollReveal variant="fade-left" delay={0.2} className="lg:col-span-5 flex justify-center lg:justify-end w-full">
            <HeroPacMaze />
          </ScrollReveal>
