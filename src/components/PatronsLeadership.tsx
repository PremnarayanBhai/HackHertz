...
export const PatronsLeadership: React.FC = () => {
  return (
    <SectionWrapper id="patrons" stageTag="STAGE 08" accent="purple" bgVariant="indigo" animVariant="flip-up" className="py-24">
        ...
        <ScrollReveal variant="fade-up">
          <div className="text-center space-y-4 max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-yellow-400/10 border border-yellow-400/30 text-yellow-400 font-pixel text-xs">
              <span>STAGE 08: INSTITUTIONAL LEADERSHIP</span>
            </div>
            <h2 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight">
              PATRONS & <span className="font-pixel text-yellow-400 neon-text-yellow">HEADS OF DEPARTMENT</span>
            </h2>
            <p className="text-slate-300 text-lg">
              Esteemed institutional mentors, visionary patrons, and academic leaders guiding HACKHERTZ 2.0.
            </p>
          </div>
        </ScrollReveal>
            ...
            >
              ...
              <div className="space-y-5 text-center mt-2">
                ...
                <div>
                  ...
                  <div className="inline-block mt-1 px-3 py-0.5 rounded bg-yellow-400/10 text-yellow-300 text-xs font-mono font-bold border border-yellow-400/30">
                    Chief Patron
                  </div>
                  <p className="text-xs text-slate-400 font-semibold mt-2 flex items-center justify-center gap-1.5">
            ...
            >
              ...
              <div className="space-y-5 text-center mt-2">
                ...
                <div>
                  ...
                  <div className="inline-block mt-1 px-3 py-0.5 rounded bg-cyan-400/10 text-cyan-300 text-xs font-mono font-bold border border-cyan-400/30">
                    Co-Patron
                  </div>
                  <p className="text-xs text-slate-400 font-semibold mt-2 flex items-center justify-center gap-1.5">
