        ...
        <div className="p-4 sm:p-8 overflow-y-auto flex-1 bg-gradient-to-b from-[#090d24] to-[#040614] min-h-[460px]">
          ...
          {currentSlide === 1 && (
            <div className="flex flex-col items-center justify-center text-center space-y-6 py-8 animate-fadeIn max-w-3xl mx-auto">
              ...
              <div className="space-y-3 pt-2">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 p-3 rounded-2xl bg-slate-950/80 border border-yellow-500/30 max-w-md mx-auto">
                  <SSITLogo size="sm" glow={true} className="w-9 h-9 shrink-0" />
                ...
                <div className="pt-1 flex items-center justify-center">
                  <div className="inline-flex items-center gap-2.5 px-3 py-1.5 rounded-xl bg-slate-950 border border-red-500/40">
                    <SSIPLogo size="xs" glow={false} />
                    <span className="text-[10px] font-pixel text-red-400">SUPPORTED BY SSIP GUJARAT</span>
                  </div>
                </div>
              </div>
          ...
          {currentSlide === 8 && (
            <div className="space-y-6 animate-fadeIn max-w-3xl mx-auto py-2 text-center">
              ...
              {/* Footer Note */}
              <div className="pt-2 text-xs text-slate-400 font-mono flex flex-wrap items-center justify-center gap-3">
                <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-slate-900 border border-yellow-500/30">
                  <SSITLogo size="xs" glow={false} className="w-4 h-4" />
                  <span className="text-[10px] font-bold text-slate-200">Organized by Shree Swaminarayan Institute of Technology</span>
                </div>
                <span>•</span>
                <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-slate-900 border border-red-500/30">
                  <SSIPLogo size="xs" glow={false} />
                  <span className="text-[10px] font-pixel text-red-400">Supported by SSIP Gujarat</span>
                </div>
              </div>
