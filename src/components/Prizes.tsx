        ...
        <ScrollReveal variant="fade-up">
          <div className="text-center space-y-4 max-w-3xl mx-auto">
            ...
            <p className="text-slate-300 text-lg">
              Exciting cash rewards of ₹XXXX, trophies, sponsor perks, and cloud computing credits!
            </p>
          </div>
        </ScrollReveal>
            ...
            return (
              <ScrollReveal variant="arcade-bounce" delay={0.2} className="lg:order-2 w-full">
                ...
                >
                  ...
                  <ul className="space-y-2.5 pt-3 border-t border-slate-800 text-xs sm:text-sm text-slate-200">
                    {p.perks.map((perk, i) => (
                      <li key={i} className="flex items-start gap-2">
