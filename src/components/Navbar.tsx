...
import { Volume2, VolumeX, Menu, X, Trophy, Music, Disc3, MessageCircle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            >
              <HackHertzLogo size="sm" variant="badge" className="group-hover:scale-110 transition-transform duration-300 w-10 h-10 sm:w-11 sm:h-11" />
              <div>
                <span 
          ...
          <div className="hidden sm:flex items-center gap-2.5">
            ...
            {/* REGISTER NOW Button (Direct Google Form Link) */}
            <a
              ...
              onMouseEnter={() => soundManager.playHover()}
              className="relative group px-5 py-2.5 rounded-lg font-pixel text-xs bg-yellow-400 text-slate-950 font-bold tracking-wider hover:bg-yellow-300 transition-all shadow-[0_0_20px_rgba(250,204,21,0.5)] active:scale-95 inline-flex items-center"
            >
          ...
          <div className="pt-2 space-y-2">
            ...
            {hackathonInfo.socialLinks.whatsapp && (
              <a
                ...
                className="w-full py-2.5 rounded-lg font-pixel text-xs bg-emerald-500/20 text-emerald-300 hover:text-white border border-emerald-500/50 flex items-center justify-center gap-2 shadow-[0_0_12px_rgba(16,185,129,0.2)]"
              >
