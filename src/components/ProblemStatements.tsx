...
export const ProblemStatements: React.FC<ProblemStatementsProps> = ({ onOpenRegister }) => {
  ...
  return (
    <SectionWrapper id="problems" stageTag="STAGE 04" accent="yellow" bgVariant="obsidian" animVariant="slide-left" className="py-24">
        ...
        <ScrollReveal variant="fade-up">
          <div className="text-center space-y-4 max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-yellow-400/10 border border-yellow-400/30 text-yellow-400 font-pixel text-xs">
              ...
              <span>STAGE 04: CHALLENGE ARENA</span>
            </div>
            
            <h2 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight flex flex-wrap items-center justify-center gap-3">
              <span>PROBLEM</span>
              <span className="font-pixel text-yellow-400 neon-text-yellow">STATEMENTS</span>
              <span className="text-xs sm:text-sm font-pixel px-3 py-1 rounded-full bg-rose-500/20 text-rose-400 border border-rose-500/40 uppercase tracking-widest inline-flex items-center gap-1.5 shadow-[0_0_15px_rgba(244,63,94,0.3)]">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
              ...
              <div className="space-y-6 max-w-2xl text-center lg:text-left">
                ...
                <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-2">
                  ...
                  >
                    <span>PRE-REGISTER YOUR TEAM</span>
                ...
                <ScrollReveal key={dom.id} variant="pixel-pop" delay={idx * 0.06}>
                  ...
                  >
                    ...
                    <div className="pt-5 mt-3 border-t border-slate-800">
                      ...
                      >
                        <span>Choose {dom.name.split('&')[0].trim()}</span>
